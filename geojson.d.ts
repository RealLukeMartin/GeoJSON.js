...
export interface GEOJSON {
    ...
    parse<D extends Data = any, G extends Geometry | null = Geometry, P = any>(data: D, params?: Params, callback?: (geojson: D extends any [] ? FeatureCollection<G, P> : Feature<G, P>) => void): D extends any [] ? FeatureCollection<G, P> : Feature<G, P>;
}
